...
HD_PWD='C:/Xilinx/Vivado/XADC_to_display/XADC_to_display.runs/dds_compiler_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_compiler_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_compiler_0.tcl
