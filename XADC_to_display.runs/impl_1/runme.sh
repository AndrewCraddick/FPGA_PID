...
HD_PWD='C:/Xilinx/Vivado/FPGA_PID/XADC_to_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDS_top.tcl -notrace
